...
(0, _jquery2.default)(function () {
    ...
    var sidebar = (0, _jquery2.default)('.sidebar'),
        sidebarInner = (0, _jquery2.default)('.sidebar__inner'),
        header = (0, _jquery2.default)('.header'),
        footer = (0, _jquery2.default)('.footer'),
        trigger = (0, _jquery2.default)('.primary-nav__link[data-trigger=sidebar]');

    var resizeSidebar = function resizeSidebar() {
        var headerHeight = header.height(),
            sidebarHeight = (0, _jquery2.default)(document).height() - headerHeight,
            windowWidth = (0, _jquery2.default)(window).width(),
            sidebarInnerHeight = (0, _jquery2.default)(window).height() - headerHeight;
    ...
    (0, _jquery2.default)(window).on('resize', resizeSidebar);
    resizeSidebar();
});
